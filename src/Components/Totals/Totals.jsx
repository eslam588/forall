    ...
    <div className='mt-3 d-flex align-items-center justify-content-between dataview gap-3'>
        <Card  sx={{width : 'fit-content' , paddingBottom : "0" , padding : '0'}}>
            <CardContent className='p-0 '>
                ...
                <h2 style={{color : '#45C0BE'}}>{sales != null ?Math.floor(sales.total.earning * 100) / 100 :  loader == true ? <CircularProgress color='inherit'/>  : '0.00'}</h2>
                </div>
        ...
        <Card  sx={{width : 'fit-content' , paddingBottom : "0" , padding : '0'}}>
            <CardContent className='p-0 '>
                ...
                <h2 style={{color : '#E4D366'}}>{sales != null ? sales.total.agencies :  loader == true ? <CircularProgress color='inherit'/>  : '0.00'}</h2>
                </div>
        ...
        <Card  sx={{width : 'fit-content' , paddingBottom : "0" , padding : '0'}}>
            <CardContent className='p-0 '>
                ...
                <h2 style={{color : '#BE5252'}}>{sales != null ? sales.total.vendors :  loader == true ? <CircularProgress color='inherit'/>  : '0.00'}</h2>
                </div>
