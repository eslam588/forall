  ...
  return (
    <div className='mt-5 position-relative'>
       ...
       <div className='mt-3 d-flex align-items-center justify-content-between dataview gap-3'>
        <Card  sx={{width : 'fit-content' , paddingBottom : "0" , padding : '0'}}>
            <CardContent className='p-0 '>
                ...
                <h2 style={{color : '#45C0BE' , fontSize : "20px"}}>{userData != null  ? userData?.data.employees != null ? userData.data.employees.earning : '0.00' :  loaderteam == true ? <CircularProgress color='inherit' className='mangerPhoto'/>  : ''}</h2>
                </div>
        ...
        <Card  sx={{width : 'fit-content' , paddingBottom : "0" , padding : '0'}}>
            <CardContent className='p-0 '>
                ...
                <h2 style={{color : '#E4D366' , fontSize : "20px"}}>{userData != null ? userData?.data.employees != null ? userData.data.employees.vendors.length  : '0.00' :  loaderteam == true ? <CircularProgress color='inherit' className='mangerPhoto'/>  : ''}</h2>
                </div>
        ...
        <Card  sx={{width : 'fit-content' , paddingBottom : "0" , padding : '0'}}>
            <CardContent className='p-0 '>
                ...
                <h2 style={{color : '#BE5252' , fontSize : "20px"}}>{userData != null ? userData?.data.employees != null ? userData.data.employees.agents.length : '0.00' :  loaderteam == true ? <CircularProgress color='inherit' className='mangerPhoto'/>  : ''}</h2>
                </div>
                  ...
                  userData != null ? (
                    ...
                    <input type='text' placeholder={t('Search')} className='border-0 outline-0 ps-3 searchinIput'  onChange={(e)=>searchAgencies(e.target.value)} /> 
                     ...
                     document.getElementById('myImg').src = document.getElementById('avatar3').src
                      ...
                      <Avatar >
                        <img id="avatar3" alt="Company Logo" width="100%" src={e.company != null ? e.company.logo != null ?  e.company.logo['512px'] : '/assests/assets/avatar.png' : '/assests/assets/avatar.png' }  />
                        </Avatar>
                                  </div>
                                 <div className='flex-special'>
                              <span>{e.email}</span>
                   ...
                   <div>
      {
         ...
         onClick={()=>{
          document.getElementById('imgView').style.display = 'flex'
          document.getElementById('myImg').src = document.getElementById('avatar6').src
        }}
        >
     <Avatar >
        <img id='avatar6' alt="Logo" width="100%"  src={userData.data.employees.employees[0].image != null ? userData.data.employees.employees[0].image['512px'] : '/assests/assets/avatar.png' } />
      </Avatar>
     </StyledBadge>
         ...
         onClick={()=>{
          document.getElementById('imgView').style.display = 'flex'
          document.getElementById('myImg').src = document.getElementById('avatar7').src
        }}
        >
     <Avatar>
      ...
      <div className='flex-special'>
          <span>{userData.data.employees.employees[0].name}</span>
          {
                   ...
                   <div>
      {
         ...
         onClick={()=>{
          document.getElementById('imgView').style.display = 'flex'
          document.getElementById('myImg').src = document.getElementById('avatar8').src
        }}
        >
     <Avatar  >
        <img id="avatar8" alt="Logo" width="100%" src={userData.data.employees.employees[1].image != null ? userData.data.employees.employees[1].image['512px'] : '/assests/assets/avatar.png' }/>
      </Avatar>
     </StyledBadge>
         ...
         onClick={()=>{
          document.getElementById('imgView').style.display = 'flex'
          document.getElementById('myImg').src = document.getElementById('avatar9').src
        }}
        >
     <Avatar  >
      ...
      <div className='flex-special'>
          <span>{userData.data.employees.employees[1].name}</span>
          {
                   ...
                   <div>
      {
        ...
        >
     <Avatar >
      <img alt="Logo" id="avatar10" width="100%" src={userData.data.employees.employees[0].image != null ? userData.data.employees.employees[0].image['512px'] : '/assests/assets/avatar.png' }/>
     </Avatar>
     </StyledBadge>
                 ...
                 <Card className='mt-3  h-50 overflowAuto specialWidth'>
                      ...
                      userData != null ? (
                                       ...
                                       <div>
                          {
                             ...
                             onClick={()=>{
                              document.getElementById('imgView').style.display = 'flex'
                              document.getElementById('myImg').src = document.getElementById('avatar12').src
                            }}
                            >
                         <Avatar  >
          ...
          userData != null ? vendorLength == 0 ? '' ||  userData.data.employees == null :  
                ...
                <Avatar >
                  <img alt="Company Logo" id='avatar15' src={ userData.data.employees.vendors[1].company != null ?  userData.data.employees.vendors[1].company.logo != null ?   userData.data.employees.vendors[1].company.logo['512px'] : '/assests/assets/avatar.png' : '/assests/assets/avatar.png' }/>
                           ...
                           <Grid item xs={4} md={4}>
                        <span>{ userData.data.employees.vendors[1].email}</span>
                           </Grid>
                           <Grid item xs={4} md={4}>
                  {
            ...
            userData.data.employees == null ? '' : 
                    ...
                    <input type='text' placeholder={t('Search')} className='border-0 outline-0 ps-3 searchinIput'  onChange={(e)=>searchVendors(e.target.value)} /> 
                        ...
                        <StyledBadge
                          ...
                          onClick={()=>{
                           document.getElementById('imgView').style.display = 'flex'
                           document.getElementById('myImg').src = document.getElementById('avatar17').src
                         }}
                          >
                      <Avatar >
                        <img id='avatar17' width="100%" alt="Company Logo" src={e.company != null ? e.company.logo != null ?  e.company.logo['512px'] : '/assests/assets/avatar.png' : '/assests/assets/avatar.png' } />
                        </Avatar>
                      </StyledBadge>
                                  </Grid>
